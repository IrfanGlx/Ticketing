                ...
                <div class="panel-body">                    
                    ...
                    <div class="row">
                        <div class="col-md-6">                            
                            ...
                            <form id="edit-form" action="{{ url('customer') }}/{{ $customer->id }}/edit" method="POST" style="display: none;">
                                {{ csrf_field() }}
                            </form>
                        </div>
                        <div class="col-md-6">                            
                          ...
                          <div class="modal fade bs-example-modal-sm" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel">
                              <div class="modal-dialog modal-sm" role="document">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel">Yakin Ingin Membatalkan Pesanan"
                                    <a onclick="event.preventDefault();document.getElementById('delete-form').submit();" class="btn btn-danger">Delete</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <form id="delete-form" action="{{ url('customer') }}/{{ $customer->id }}/destroy" method="POST" style="display: none;">
                        {{ csrf_field() }}
                    </form>
                </div>                        
            </div>
